    ...
    <div class="page-header">
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            <h4 class="mb-0">Edit Branch  برانچ میں ترمیم کریں۔</h4>
          </div>
          ...
          <div class="card shadow">
            <div id="sticky-action" class="sticky-action">
              <div class="card-header">
                <div class="row align-items-center">
                  <div class="col-sm-6">
                    <h5>اس سیکشن میں صارف برانچ میں ترمیم کر سکتا ہے۔</h5>
                  </div>
              ...
              <form method="POST" action="{{ route('branches.update') }}">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 mt-2">
                    ...
                    <input type="text" value="{{ $branch->branch_name }}" name="branch_name" class="form-control" required>
                  </div>

                  <div class="col-sm-6 mt-2">
                    <label>Branch address برانچ کا پتہ <small class="text text-danger">*</small></label>
                    <input type="text" value="{{ $branch->branch_address }}" name="branch_address" class="form-control" required>
                  </div>

                  <div class="col-sm-4 mt-4">
                    <label>Branch Contact Person برانچ کا مالک<small class="text text-danger">*</small></label>
                    <input type="text" value="{{ $branch->branch_contact_person }}" name="branch_contact_person" class="form-control" required>
                  </div>

                  <div class="col-sm-4 mt-4">
                    <label>Phone   برانچ کے مالک کا فون<small class="text text-danger">*</small></label>
                    <input type="text" value="{{ $branch->branch_phone }}" name="branch_phone" class="form-control" required>
                  </div>

                  <div class="col-sm-4 mt-4">
                    <label> Email ای میل<small class="text text-danger"></small></label>
                    <input type="email" value="{{ $branch->branch_email }}" name="branch_email" class="form-control" >
                  </div>
