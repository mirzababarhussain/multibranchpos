        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12">
            <div class="page-header-title">
              <h4 class="mb-0">Pay to Vendor </h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          <div class="row">
                ...
                <div class="col-sm-6">
                  <h4>Payment To  Vendor<br>اکاؤنٹ میں ادائیگی</h4>
  ...
  <script>
    ...
    function save_payment(){
      ...
      if(payment_from == ""){
        ...
        error_msg('warning','Please select Vendor<br> براہ کرم وینڈر کو منتخب کریں۔');
      ...
      loading_msg();
      var url = "{{ route('ledger.pay_to_vendor') }}";
      $.ajax({
        url:url,
        type:'POST',
        data:{
    ...
    $(document).ready(function(){ 
            ...
            $('#vendor').change(function (e) { 
                e.preventDefault();
                    var id = $(this).val();
                    let a = '{{ route("vendors.show_json","id")}}';
                ...
                $.ajax({
                    ...
                    success : function(data){
                      ...
                      $('#v_data').append('<h3>'+data.vendor['v_name']+' <span class="float-end text text-danger">'+data.balance['balance']+'</span></h3>');
                      $('#v_data').append('<h4>'+data.vendor['v_address']+'</h4>');
                      $('#v_data').append('<h4>'+data.vendor['v_phone']+'</h4>');
                      $('#v_data').append('<h4>'+data.vendor['v_email']+'</h4>');
                    },
