...
<div class="pc-content">
    ...
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
        <h4 class="text text-danger">Sale Return</h4>
        <div class="card">
          ...
          <div class="modal-header">
            ...
            <div class="row">
              <div class="col-xl-8">
                <div class="card shadow">
                  ...
                  <div class="card-body border-bottom bg-light">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                          <h5>Inv #: <span class="ms-2 f-14 px-2 badge bg-light-secondary rounded-pill">{{ $data->ret_inv_code }}</span></h5>
                        </div>
                        <div class="col-sm-3">
                  ...
                  <div class="card-body p-0 table-body">
                    <div class="pre-scrollable p-0" style="max-height: 250px">
                      <table class="table mb-0 border-secondary" id="pc-dt-simple">
                        <thead style="background-color:#f0e2ae">
                          <tr>
                            ...
                            <th class="text-end border-secondary"></th>
                          </tr>
                        </thead>
                ...
                <div class="text-end">
                  <button class="btn btn-shadow btn-success" onclick="return confirm_sale_invoice()">Confirm Invoice</button>
                </div>
              </div>
              <div class="col-xl-4">
                <div class="card shadow">
  ...
  <script>
    function confirm_sale_invoice(){
        ...
        let url = "{{ route('sale.confirm_sale_ret_inv') }}";
        $.ajax({
          url:url,
          type:'POST',
          data:{
          ...
          success: function(data){
            window.location = "{{ route('sale.get_sale_returns') }}";
          },
     ...
     function remove_sale_products(id){
      Swal.fire({
                ...
                if (result.isConfirmed) {
                  let a = "{{ route('sale.remove_sale_return_products','id') }}";
    ...
    function add_product(){
      ...
      var url = "{{ route('sale.add_return_product') }}";
      $.ajax({
        url:url,
        type: 'POST',
        data: {
