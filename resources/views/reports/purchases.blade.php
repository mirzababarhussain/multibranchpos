    ...
    <div class="page-header">
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            <h4 class="mb-0">Purchase Report        خریداری کی رپورٹ</h4>
          </div>
                ...
                <div class="row align-items-center">
                  <div class="col-sm-5">
                    <div class="card shadow">
                      ...
                      <form method="POST" action="{{ route('reports.get_purchase_report') }}">
                        @csrf
            ...
            <div class="card-body p-0">
              <div class="table-responsive dt-responsive">
                <table  class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="background-color:#f0e2ae">Pur-Inv #<br>رسید نمبر</th>
                      <th style="background-color:#f0e2ae">Pur-Date<br>    خریداری کی تاریخ</th>
                      <th style="background-color:#f0e2ae">Vendor<br>فروش</th>
                      <th style="background-color:#f0e2ae">Inv-Status<br>حالت</th>
