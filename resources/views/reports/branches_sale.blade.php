    ...
    <div class="page-header">
      <div class="page-block">
        <div class="row align-items-center">
          <div class="col-md-12">
            <h4 class="mb-0">Sale Report      فروخت کی رپورٹ</h4>
          </div>
            ...
            <div id="sticky-action" class="sticky-action">
              <div class="card-header">
                ...
                <div class="row align-items-center">
                  <div class="col-sm-5">
                    <div class="card shadow">
                      <div class="card-header">
                        <h5>Branch Sale Report</h5>
                      </div>
                      <form method="POST" action="{{ route('reports.get_sale_report') }}">
                        @csrf
                ...
                <h5>{{ $report_heading }}
                  ...
                  <a href="{{ route('reports.sale_report') }}" class="btn btn-primary float-end mr-3"><i class="fas fa-backward"></i> Back</a>
            ...
            <div class="card-body p-0">
              <div class="table-responsive dt-responsive">
                <table  class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th style="background-color:#f0e2ae">Inv #<br>رسید نمبر</th>
                      ...
                      <th style="background-color:#f0e2ae">Profit<br>   خریدار کا منافع</th>
                  ...
                  <tbody>
                    ...
                    @foreach ( $datas as $data)
                      <tr>
                        ...
                        <td>{{ number_format($data->total_sale) }}</td>
                        <td>{{ $data->customer_code }}-{{ $data->name }}</td>
                        <td>{{ number_format($data->customer_profit) }}</td>
                      </tr>
                      @php
                        $g_total = $g_total + $data->total_sale;
                        $g_profit = $g_profit + $data->customer_profit;
                      @endphp
                    @endforeach
                    <tr>
